...
#EXTRA CREDIT:
    #RANDOM LINE LENGTH AND ANGLE BASED ON GIVEN VALUES
############################################################################
...
def graph(angle, number_of_iterations, axiom, grammar_list):
    ...
    for i in l_system_string:
        # Sets a semi-random line length
        line_length = rand.uniform((12 // (number_of_iterations**0.5)),(24 // (number_of_iterations**0.6)))
        ...
        # Sets a semi-random angle
        elif i == "+":
            angle2 -= (rand.uniform((angle - math.radians(8)),(angle + math.radians(8))))
